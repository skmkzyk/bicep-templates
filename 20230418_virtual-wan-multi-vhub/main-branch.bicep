...
// resource _vnets_branch 'Microsoft.Network/virtualNetworks@2022-09-01' = [for i in [ 0, 1, 4, 5, 16, 17, 18, 19, 20, 21 ]: {
//   name: 'vnet${i + 100}'
//   location: location01
//   properties: {
//     addressSpace: {
...
// module _ergws_branch '../lib/ergw.bicep' = [for i in [ 0, 1, 4, 5, 16, 17, 18, 19, 20, 21 ]: {
//   name: 'ergw${i + 100}'
//   params: {
//     location: location01
...
// resource connections_branch 'Microsoft.Network/connections@2022-09-01' = [for i in [ 0, 1, 4, 5, 16, 17, 18, 19, 20, 21 ]: {
...
// module vms_branch '../lib/ws2019.bicep' = [for i in [ 0, 1, 4, 5, 16, 17, 18, 19, 20, 21 ]: {
//   name: 'vm${i + 100}'
//   params: {
//     location: location01
